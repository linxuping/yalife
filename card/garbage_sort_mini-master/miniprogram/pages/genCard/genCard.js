...
Page({
  ...
  onLoad: function (options) {
    console.log("genCard.onLoad.");
    var that = this;
    wx.getStorage({
      key: 'userinfo',
      success: function(res) {
        console.log("userinfo: ", res.data);
        that.loadPortraitPath(res.data.avatarUrl);
        defaultOptions.nickName = res.data.nickName;
      },
    })
    /*
    console.log("onload.");
    ...
    */
    ...
    var makeImg = function (imgUrl, callback) {
      try {
        ...
        var x = 25; //defaultOptions.bg_width - 260;
...
*/
        ...
        //ctx.fillText(that.data.followText[0], 230, 60) //defaultOptions.nickName
        ctx.fillText(defaultOptions.nickName, 170, 60)
        ctx.restore();
        ctx.setFontSize(36)
